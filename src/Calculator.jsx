    ...
    const [athletes, setAthletes] = useState([
        {
            ...
            boat: defaultBoat,
            segments: [{ distance: defaultDistance, time: '' }],
        },
    ]);
    ...
    React.useEffect(() => {
        setAthletes((athletes) =>
            athletes.map((ath) => ({
                ...
                boat: Object.keys(
                    currentModel[Object.keys(currentModel)[0]]
                )[0],
            }))
        );
    }, [currentModel]);
        ...
        <div style={styles.page}>
            ...
            <div style={styles.card}>
                ...
                {athletes.map((ath, idx) => (
                    <div
                        key={idx}
                        style={{ ...styles.section, ...styles.segmentBlock }}
                    >
                        <div style={styles.flexRow}>
                            ...
                            <select
                                ...
                                style={styles.select}
                            >
                                {Object.keys(currentModel[ath.category]).map(
                                    (boat) => (
                ...
                <button onClick={addAthlete} style={styles.button}>
                    Добавить спортсмена
                </button>
                <br />
                <button
